...
/**
 * Single-line live activity ticker — shows one event at a time, snapping to the
 * newest as it appears and otherwise rotating through the most recent events.
 */
export function ActivityTicker() {
  ...
  // Snap to the newest whenever a fresh event arrives.
